...
SENDER_SRC = $(SRC_DIR)/rma.c $(SRC_DIR)/dma.c $(SRC_DIR)/dma_channel.c $(SRC_DIR)/rnid_util.c $(SRC_DIR)/sender.c
SENDER_OBJS = $(BUILD_DIR)/rma.o $(BUILD_DIR)/dma.o $(BUILD_DIR)/dma_channel.o $(BUILD_DIR)/rnid_util.o $(BUILD_DIR)/sender.o
